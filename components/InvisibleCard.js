...
const InvisibleCard = ({ color, setBookTitle, selectedBook, setSelectedBook, onChangeChapter, whatChapter, totalContents, watermark, setModalVisible, backgroundImage, setContentsByLine, ocrLoading, align, }) => {
